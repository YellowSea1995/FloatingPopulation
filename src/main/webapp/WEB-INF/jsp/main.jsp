...
<head>
	...
	<frameset rows="82,*" cols="*" id="tstMain" frameborder="no" border="0" framespacing="0">
		<frame src="${ctx }/head.action" name="topframe"  id="topframe" />
		<frameset id="fstMain" border="0" cols="148,*" rows="*" frameborder="no">
    		<frame src="${ctx}/left.action" name="leftframe" scrolling="no" id="leftframe"/>
	        <frameset border="0" rows="*,28" cols="*" frameborder="no">
	            <frame src="${ctx}/tab.action" name="mainframe" id="mainframe"/>
	            <frame src="${ctx}/button.action">
	        </frameset>
	    </frameset>
	</frameset>
	<noframes>
